...
class Connection extends Thread {
    ...
    public void run() { // an echo server
        try {
            ...
            printFields(BattleField2, BattleField1);
            ...
            for (int i = 0; i < 10; i++){
                ...
                inputField(BattleField2, i, scanner);
                printFields(BattleField2, BattleField1);
            }
            ...
            while(true) {
                // Ход противника
                counterEnemyHits = enemyTurn(counterEnemyHits, BattleField2, BattleField1, in, out);
                if (checkEnd(counterEnemyHits, "enemyTurn"))
                    break;

                // Ход переходит нам
                counterMyHits = myTurn(counterMyHits, BattleField2, BattleField1, in, out, scanner);
